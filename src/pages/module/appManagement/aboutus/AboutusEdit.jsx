...
function AboutusEdit() {
  ...
  const { aboutUs, loading, fetchAboutUs, updateAboutUs, deleteAboutUsImage } =
    useAboutUs();
  ...
  const validationSchema = Yup.object({
    ...
    missionDescription: Yup.string().required(
                ...
                <div className="mb-8">
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFieldValue("heroTitle", e.target.value)
                      }
                  ...
                  <div className="mb-4">
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setFieldValue("heroDescription", e.target.value)
                      }
                      rows={4}
                      className="w-full border rounded-lg px-3 py-2"
                      ...
                      {aboutUs?.heroSection?.images?.map((img, idx) => (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleDeleteExistingImage("heroSection", img._id)
                            }
                      ...
                      {heroImages.map((img, idx) => (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleRemoveNewImage(setHeroImages, idx)
                            }
                            className="absolute top-2 right-2 bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-red-600"
                          >
                            ×
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFieldValue("sellingProducts", e.target.value)
                        }
                        className="w-full border rounded-lg px-3 py-2"
                        placeholder="50K+"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFieldValue("satisfiedCustomer", e.target.value)
                        }
                        className="w-full border rounded-lg px-3 py-2"
                        placeholder="15K+"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFieldValue("worldwideHonors", e.target.value)
                        }
                        className="w-full border rounded-lg px-3 py-2"
                        placeholder="10+"
                      />
                  ...
                  <div className="flex items-center justify-between border rounded-lg p-4">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setFieldValue("customerRating", e.target.checked)
                        }
                ...
                <div className="mb-8">
                  ...
                  <div className="mb-4">
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setFieldValue("missionDescription", e.target.value)
                      }
                      rows={4}
                      className="w-full border rounded-lg px-3 py-2"
                    ...
                    <div className="flex gap-4 flex-wrap">
                      {aboutUs?.ourMission?.images?.map((img) => (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleDeleteExistingImage("ourMission", img._id)
                            }
                            className="absolute top-2 right-2 bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-red-600"
                          >
                            ×
                      ...
                      {missionImages.map((img, idx) => (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleRemoveNewImage(setMissionImages, idx)
                            }
                            className="absolute top-2 right-2 bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-red-600"
                          >
                            ×
                      ...
                      <label className="border-2 border-dashed rounded-lg p-4 w-40 h-40 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50">
                        ...
                        <input
                          ...
                          accept="image/*"
                          onChange={(e) =>
                            handleImageChange(e, setMissionImages)
                          }
                          className="hidden"
                        />
                      </label>
                ...
                <div className="mb-8">
                  ...
                  <div className="mb-4">
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setFieldValue("visionDescription", e.target.value)
                      }
                      rows={4}
                      className="w-full border rounded-lg px-3 py-2"
                    ...
                    <div className="flex gap-4 flex-wrap">
                      {aboutUs?.ourVision?.images?.map((img) => (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleDeleteExistingImage("ourVision", img._id)
                            }
                            className="absolute top-2 right-2 bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-red-600"
                          >
                            ×
                      ...
                      {visionImages.map((img, idx) => (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleRemoveNewImage(setVisionImages, idx)
                            }
                            className="absolute top-2 right-2 bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-red-600"
                          >
                            ×
                      ...
                      <label className="border-2 border-dashed rounded-lg p-4 w-40 h-40 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50">
                        ...
                        <input
                          ...
                          accept="image/*"
                          onChange={(e) =>
                            handleImageChange(e, setVisionImages)
                          }
                          className="hidden"
                        />
                      </label>
                    ...
                    <div key={num} className="border-t pt-6 mt-6">
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    handleDeleteExistingImage(
                                      `ourTeam${num}`,
                                      aboutUs.ourTeam[teamIdx].image._id
                                    )
                                  }
                          ...
                          {teamImages[teamIdx] && (
                            <div className="relative border rounded-lg overflow-hidden">
                              ...
                              <button
                                type="button"
                                onClick={() =>
                                  handleRemoveNewImage(setTeamImages, teamIdx)
                                }
                                className="absolute top-0 right-0 bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-red-600"
                              >
                                ×
                            ...
                            !aboutUs?.ourTeam?.[teamIdx]?.image && (
                              <label className="border-2 border-dashed rounded-lg p-4 w-32 h-32 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50">
                                ...
                                <input
                                  ...
                                  accept="image/*"
                                  onChange={(e) =>
                                    handleImageChange(e, setTeamImages, teamIdx)
                                  }
                                  className="hidden"
                                />
                              </label>
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setFieldValue(`team${num}Name`, e.target.value)
                          }
                          className="w-full border rounded-lg px-3 py-2"
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setFieldValue(`team${num}Role`, e.target.value)
                          }
                          className="w-full border rounded-lg px-3 py-2"
