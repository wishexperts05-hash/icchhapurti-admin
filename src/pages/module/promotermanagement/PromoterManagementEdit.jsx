...
function PromoterManagementEdit({ onCancel, onSave }) {
  ...
  const [profileImage, setProfileImage] = useState(promoterData?.profileImage || null);
  const [formData, setFormData] = useState({
    fullName: promoterData?.name || "Jane Cooper",
    countryCode: promoterData?.countryCode || "+91",
    phoneNumber: promoterData?.phone || "9876543210",
    email: promoterData?.email || "janecooper01@gmail.com",
    dob: promoterData?.dob || "01/01/2025",
    country: promoterData?.country || "India",
    state: promoterData?.state || "Maharashtra",
    city: promoterData?.city || "Nagpur",
    bankName: promoterData?.bankName || "State Bank Of India",
    accountNumber: promoterData?.accountNumber || "654971879431",
    ifsc: promoterData?.ifsc || "SBIN0001234",
    accountType: promoterData?.accountType || "Savings",
    accountHolderName: promoterData?.accountHolderName || "Jane Cooper",
  });
