        ...
        <>
          ...
          <div className="bg-white rounded-2xl p-8 mb-4">
            <div className="flex items-center gap-6">
              ...
              <div>
                <p
                  className={`px-3 py-1 rounded-full text-white font-semibold ${staffDetail?.staff?.isActive ? "bg-green-500" : "bg-red-500"
                    }`}
                >
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-300 mt-4">
            <div className="bg-white px-6 py-4 border-b border-gray-300">
              <div className="flex items-center gap-3">
