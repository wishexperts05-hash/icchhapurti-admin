...
const AdminProfile = () => {
    ...
    return (
        <div className="w-full">
            <BreadCrumb linkText={[{ text: "Admin Profile" }]} />

            <div className="min-h-screen flex flex-col w-full">
                <PagePath2 title="Admin Profile" />
                ...
                <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6">
                    {
                        loading ? (<div className='flex w-full items-center justify-center'><LoaderSpinner /></div>) : (
                            <>
                                ...
                                {/* Info Section */}
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-gray-700 py-4">
                                ...
                                <div className="flex flex-col gap-2">
                                    <span className="font-medium text-[#004AAD]">Residential Address</span>
                                    <div className="px-3 py-3 border border-[#e65d00]/80 rounded-lg shadow-sm">
